...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "uv pip install 'xaig[daig] @ git+https://github.com/E3SM-Project/aigroup@656212e'",
        ),
        (
            {
            ...
            "uv pip install 'xaig[daig] @ git+https://example.org/mono@abc123#subdirectory=python/xaig'",
        ),
        (
            {"url": "https://example.org/xaig-0.1.0.tar.gz", "archive_info": {}},
            "uv pip install 'xaig[daig] @ https://example.org/xaig-0.1.0.tar.gz'",
        ),
